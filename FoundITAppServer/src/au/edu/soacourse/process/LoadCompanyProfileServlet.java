 ...
 */
@WebServlet("/LoadCompanyProfileServlet")
public class LoadCompanyProfileServlet extends HttpServlet {
     ...
     */
    public LoadCompanyProfileServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String serviceURLString = getServletContext().getInitParameter("RestfulURL")+"companies?managerId=";
